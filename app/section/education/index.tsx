    ...
    <div className={EducationWrapperStyle} style={style}>
        ...
        <EducationCard
            ...
            title="멋쟁이 사자처럼 11기 운영진" status="수료" day="2023. 03. ~ 2023. 12." host="계명대학교">
              <EducationCard.Content>GitHub를 주제로 정기 스터디를 진행하며, 제 전달 능력과 발표 역량을 강화할 수 있었습니다.</EducationCard.Content>
        </EducationCard>
        <EducationCard
            style={{marginTop: "30px"}}
            title="디지털 인재 양성과정" status="수료" day="2023. 02. 07. ~ 2023. 03. 03." host="메가존클라우드 아이티 평생교육원">
              <EducationCard.Content>네트워크 및 AWS 클라우드 기술을 학습했으며, 우연한 발견 프로젝트를 개발하는 과정에서 AWS ECS 기반 MSA(MicroService Architecture)를 구축하는 데 도움이 되었습니다.</EducationCard.Content>
        </EducationCard>
        <EducationCard
            style={{marginTop: "30px"}}
